...
def lambda_handler(event, context):
    ...
    for x in client['Snapshots']:
        ...
        if thiselem['KmsKeyId'] == aws_ebs:
            # execute a function
            logic(thiselem, tag_snaps, source_client,
                  client['Snapshots'], i, n, y)

        # elif thiselem['KmsKeyId'] == global_kms:
        #     #
...
def logic(thiselem, tag_snaps, source_client, client, i, n, y):
    snapshots_tag = []
    zsnap_tag_value = ''
    ysnap_tag_value = ''
    temp_tag = ''
