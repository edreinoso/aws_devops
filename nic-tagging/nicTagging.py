...
def lambda_handler(event, context):
    ...
    ec2 = client.describe_instances(
        ...
        # Testing instances
        # InstanceIds=['i-03a11bb0c6c685a89'],
        # InstanceIds=['i-0f8ec86c0942f89f3','i-03a11bb0c6c685a89'],
        # InstanceIds=['i-0f8ec86c0942f89f3'],
        # InstanceIds=['i-08a90ef3eebcc15dc'],
        # InstanceIds=['i-071f3073e22a4dbeb'],
    )
