    ...
    for instance in ec2["Instances"]:
        ...
        if areThereEC2Tags in instance:
            ...
            for tags in instance["Tags"]:
                ...
                d += 1  # increase the count to go to the other value in the array
                        ...
                        for nic_tags in networkinterfaces['TagSet']:
                            ...
                            if (nic_tags['Key'] == 'Name'):
                                ...
                                if (ec2_tag_value[x] != ""):
                                    print('Not empty!!!')
                                    print(
                                        '\tnic card name: ' + nic_tags['Value'] + ' - ec2-tag: ' + ec2_tag_value[x])
        ...
        x += 1  # increase the count to go to the other value in the array
        print(x)
        print('\n')
